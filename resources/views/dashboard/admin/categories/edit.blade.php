...
<main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
    ...
    <div class="grid">
    <p class="lead">{{ __(strtoupper('Ažuriraj Kategoriju')) }}</p>
    <div class="grid-body">
                ...
                <div class="col-md-8 mx-auto">
                    ...
                    {{ method_field('PUT') }}
	                    <div class="form-group row">
	                        ...
	                        <div class="col-md-9">
	                            <input type="text" name="category" class="form-control {{ $errors->has('category') ? 'is-invalid' : '' }}" id="inputType1" value="{{ old('category', $category->title) }}">
