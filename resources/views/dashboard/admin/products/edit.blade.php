...
<main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
    ...
    <div class="grid">
	    <p class="lead">{{ __(strtoupper('AŽuriraj Proizvod')) }}</p>
    <div class="grid-body">
                ...
                <div class="col-md-10 mx-auto">
                    ...
                    {{ method_field('PUT') }}
	                    <div class="form-group row">
	                        ...
	                        <div class="col-md-9">
	                            <input type="text" name="title" class="form-control {{ $errors->has('title') ? 'is-invalid' : '' }}" id="inputType1" value="{{ old('title', $product->title) }}">
	                            @if($errors->has('title'))
	                    ...
	                    <div class="form-group row">
	                        ...
	                        <div class="col-md-9">
	                            <input type="number" name="price" class="form-control {{ $errors->has('price') ? 'is-invalid' : '' }}" id="inputType2" value="{{ old('price', $product->price) }}" >
	                            @if($errors->has('price'))
	                            <div class="invalid-feedback">
	                              {{ $errors->first('price') }}
	                            </div>
	                    ...
	                    <div class="form-group row">
	                        ...
	                        <div class="col-md-9">
	                           <textarea name="description" id="description" class="form-control {{ $errors->has('description') ? 'is-invalid' : '' }} z-depth-1" rows="7">{{ old('description', $product->description) }}</textarea>
